...
#### **🔹 2.2.4 Devicesシートの作成手順**
1. **`Devices` シートを追加する**
2. **デバイス情報を入力する**

| No. | roomId | 部屋名 | デバイス名 | deviceId | 備考 |
|----|--------|------|---------|---------|----|
| 1  | 101    | test1  | エアコン | 02-202501290843-95480840 | メインのエアコン |
| 2  | 101    | test1  | 照明 | 03-202501290845-12345678 | シーリングライト |
| 3  | 102    | test2  | エアコン | 04-202501290855-98765432 | 別の部屋のエアコン |

#### **📌 入力ルール**

| **roomId** | 部屋を識別するID（Googleカレンダーの `ROOMID` と一致すること！！！） | `101` |
