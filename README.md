...
| No.| 部屋名 | デバイス名 | deviceId | 備考 |
|----|------|---------|---------|----|
| 1  |  test1  | エアコン | 02-202501290843-95480840 | メインのエアコン |
| 2  |  test1  | 照明 | 03-202501290845-12345678 | シーリングライト |
| 3  |  test2  | エアコン | 04-202501290855-98765432 | 別の部屋のエアコン |

#### **📌 留意事項**

| **deviceId** | 記載された**全てのdevceId**に対して、同じコマンドを送信
